...
const SWIMWEAR: IndustryDefinition = {
  ...
  productTypes: types([
    'One Piece', 'Bikini Tops', 'Bikini Bottoms', 'Bikini Set',
    'Tankini Tops', 'Rashies & Sunsuits', 'Dresses', 'Tops', 'Pants',
    'Skirts', 'Kaftans & Cover Ups', 'Sarongs', 'Hats', 'Sunnies',
    'Accessories', 'Bags', 'Beach Towels', 'Goggles', 'Boardshorts',
    'Mens Swimwear', 'Mens Shorts', 'Kids Swimwear',
  ], 'Swimwear'),
