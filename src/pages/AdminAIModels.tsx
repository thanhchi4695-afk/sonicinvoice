...
const JOBS: Array<{ id: string; layer: string; label: string; defaultModel: string; help: string }> = [
  ...
  { id: "brand.tag",            layer: "Brand IP",   label: "Brand tagging",         defaultModel: "anthropic/claude-sonnet-4-6", help: "187-rule tag engine + size norm" },
  { id: "product.naming",       layer: "Brand IP",   label: "Product naming",        defaultModel: "anthropic/claude-sonnet-4-6", help: "[Colour] + [Feature] + [Type]" },
  { id: "product.enrich",       layer: "Brand IP",   label: "Product enrich",        defaultModel: "anthropic/claude-sonnet-4-6", help: "Full Shopify-ready row" },
  { id: "seo.description",      layer: "Brand IP",   label: "SEO description",       defaultModel: "anthropic/claude-sonnet-4-6", help: "Long-form SEO copy" },
  { id: "collection.architect", layer: "Brand IP",   label: "Collection architect",  defaultModel: "anthropic/claude-sonnet-4-6", help: "Collection structure / hierarchy" },
...
const MODEL_OPTIONS = [
  ...
  { value: "anthropic/claude-sonnet-4-5",      label: "Claude Sonnet 4.5 (fallback)" },
