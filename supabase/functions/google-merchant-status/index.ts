...
Deno.serve(async (req) => {
  ...
  try {
    ...
    // TODO: When GMC OAuth credentials are wired up, call the Merchant API
    //   GET https://shoppingcontent.googleapis.com/content/v2.1/{merchantId}/products
    //   GET https://shoppingcontent.googleapis.com/content/v2.1/{merchantId}/productstatuses
    // For now we rely on the Shopify-derived fallback so the dashboard
    // surfaces actionable counts immediately.
